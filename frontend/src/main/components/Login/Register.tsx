                  ...
                  <div className="card card-plain">
                    ...
                    <div className="card-body">
                      ...
                      <label className="form-label">
                        ...
                        {validationNombre && (
                          <p className="text-success text-primary text-gradient font-weight-bold" style={{ fontSize: "smaller" }}>
                            {validationNombre}
                          </p>
                        )}
                        <label className="form-label">
                        ...
                        <div className="input-group input-group-outline font-error mb-3">
